...
batch_snf <- function(dl,
    ...
    if (max_k >= n_patients) {
        metasnf_error(
            "The highest value of k in the settings_df ({max_k}) ",
    ...
    #  - row_id (1 column): number matching the row of the settings_df used
    ...
    ###########################################################################
    # 5a. solutions_matrix begins as the settings_df extended with one new
