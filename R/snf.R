...
#' @param loneliness loneliness dataframe generated by the `get_loneliness`
#'  function
#' @param screen_time screen_time dataframe generated by the `get_screen_time`
#'  function
#' @param family_function family_function dataframe generated by the
#'  `get_family_function`
#'  function
#' @param sports sports dataframe generated by the `get_sports_and_activities`
#'  function
#' @param prosocial prosocial dataframe generated by the `get_prosocial`
#'  function
#' @param parent_psych parent_psych dataframe generated by the
#'  `get_parent_psych` function
#' @param exercise exercise dataframe generated by the `get_exercise` function
#'
#' @export
