...
#' Execute design matrix function based on apply rather than for loop
#'
#' @param data_list nested list of input data generated by the function
#'  `get_data_list()`
#' @param design_matrix matrix indicating parameters to iterate SNF through
...
edm_high <- function(data_list, design_matrix) {
    ...
    output_matrix <-
        ...
        apply(design_matrix, 1, dm_row_fn, dl = data_list)
        #parallel::parRapply(cl, design_matrix, 1, dm_row_fn, dl = data_list)
