...
#' @param ... Additional arguments for arrangeion.
...
#' @export
arrange.solutions_df <- function(.data, ..., .by_group = FALSE) {
    metasnf_error("`arrange` cannot be used on `solutions_df` class objects.")
}

#' @export
arrange.ext_solutions_df <- function(.data, ..., .by_group = FALSE) {
    metasnf_error(
...
#' @export
arrange.t_solutions_df <- function(.data, ..., .by_group = FALSE) {
    metasnf_error(
...
#' @export
arrange.t_ext_solutions_df <- function(.data, ..., .by_group = FALSE) {
    metasnf_error(
...
#' @export
arrange.settings_df <- function(.data, ..., .by_group = FALSE) {
    metasnf_error(
...
#' @export
arrange.snf_config <- function(.data, ..., .by_group = FALSE) {
    metasnf_error(
...
#' @export
arrange.ari_matrix <- function(.data, ..., .by_group = FALSE) {
    metasnf_error(
