...
#'
#' @export
execute_design_matrix <- function() {
    print("This function has been renamed to `batch_snf`.")
}

#' deprecated function
#'
#' @export
execute_design_matrix_p <- function() {
    print("This function has been renamed to `parallel_batch_snf`.")
}
...
generate_design_matrix <- function() {
    print("This function has been renamed to `generate_settings_matrix`.")
}
...
#' @export
select_om <- function() {
    print("This function has been removed from the package.")
}
...
#'
#' @export
execute_inclusion <- function() {
    print("This function has been renamed to `drop_inputs`.")
}
...
#' @export
sol <- function() {
    print("This function has been renamed to `summarize_target_list`")
}
