...
"mean_pval", and "max_pval" summarizing the p-values of just those
features that were a part of the target list.
...
- fts:
  ...
  A vector of all features that have association p-values stored in the
  resulting extended solutions data frame.
