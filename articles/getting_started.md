...
[getting_started.Rmd](https://raw.githubusercontent.com/BRANCHlab/metasnf/main/vignettes/getting_started.Rmd)
...
The package is currently hosted on GitHub (not CRAN). The easiest way to
install `metasnf` is with the devtools package.
