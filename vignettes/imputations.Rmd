...
attributes(sol_df_imp1)$"snf_config"$"settings_df"

sol_df_imp2$"solution" <- 11:20
attributes(sol_df_imp2)$"snf_config"$"settings_df"$"solution" <- 11:20
...
sol_df <- rbind(sol_df_imp1, sol_df_imp2)
