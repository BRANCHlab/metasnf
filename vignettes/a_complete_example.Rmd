...
```{r}
complete_uids <- get_complete_uids(abcd_data, uid = "patient")

print(length(complete_uids))

# Reducing dataframes to only common subjects with no missing data
abcd_anxiety <- abcd_anxiety[abcd_anxiety$"patient" %in% complete_uids, ]
abcd_depress <- abcd_depress[abcd_depress$"patient" %in% complete_uids, ]
abcd_cort_t <- abcd_cort_t[abcd_cort_t$"patient" %in% complete_uids, ]
abcd_cort_sa <- abcd_cort_sa[abcd_cort_sa$"patient" %in% complete_uids, ]
abcd_subc_v <- abcd_subc_v[abcd_subc_v$"patient" %in% complete_uids, ]
abcd_h_income <- abcd_h_income[abcd_h_income$"patient" %in% complete_uids, ]
abcd_pubertal <- abcd_pubertal[abcd_pubertal$"patient" %in% complete_uids, ]
```
