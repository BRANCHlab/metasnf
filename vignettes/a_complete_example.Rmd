...
ext_sol_df$"uid_NDAR_INVLDQH8ATK"
ext_sol_df$"uid_NDAR_INVLF3TNDUZ"

annotation_data |> 
dplyr::mutate(
        a = uid_NDAR_INVLDQH8ATK == uid_NDAR_INVLF3TNDUZ
    )

ext_sol_df$"uid_NDAR_INV0567T2Y9" <- as.character(ext_sol_df$"uid_NDAR_INV0567T2Y9")
