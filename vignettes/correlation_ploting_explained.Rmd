...
c2_ages <- sample(c(12:18), 100, replace = TRUE, prob = c(7:1))
...
#return_annotation <- function(data_list) {
#
#}
...
row_ha <- ComplexHeatmap::rowAnnotation(
    ...
    #),
    #text = anno_text(
    #    additional_data$"asthma"
    #),
    show_legend = TRUE
)
# top annotation
top_ha <- ComplexHeatmap::HeatmapAnnotation(
    Diagnosis = additional_data$"diagnosis",
    Atopic_Asthma = additional_data$"asthma",
    col = list(
        Diagnosis = c(
...
# Are the annotations re-ordered correctly?
displayClustersHeatmap(
    similarity_matrix,
    cluster_solution,
    scale_diag = "mean",
    log_graph = TRUE,
