...
train_abcd_h_income <- keep_split(abcd_h_income, assigned_splits, "train", uid = "patient")
...
test_abcd_h_income <- keep_split(abcd_h_income, assigned_splits, "test", uid = "patient")
...
test_data_list <- generate_data_list(
    ...
    list(test_abcd_h_income, "household_income", "demographics", "continuous"),
