...
output:
    rmarkdown::html_vignette:
        toc: true
description: >
  Linearly regress out unwanted signal from variables for clustering.
vignette: >
...
Linearly adjusting categorical/factor variables is not possible.
Attempting to adjust data that has a discrete or ordinal structure will likely not completely remove the association between the regressor variables and the variables being regressed.
