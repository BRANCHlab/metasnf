...
* `solution`: A label to keep track of which generated cluster solution is which
...
* Columns ending in `dist`: Which distance metric is being used for the various types of features (more on this 
...
There's one row in the weights matrix corresponding to every row in the settings data frame.
