...
solutions_matrix_with_ones_for_weights <- batch_snf(
    data_list,
    settings_matrix,
    distance_metrics_list = my_distance_metrics,
...
solutions_matrix_with_no_weights <- batch_snf(
    data_list,
    settings_matrix,
    distance_metrics_list = my_distance_metrics
)
...
identical(
    solutions_matrix_with_no_weights,
    solutions_matrix_with_ones_for_weights
...
solutions_matrix_with_uniform_random_weights <- batch_snf(
    data_list,
    settings_matrix,
    distance_metrics_list = my_distance_metrics,
    weights_matrix = weights_matrix
...
identical(
    solutions_matrix_with_no_weights,
    solutions_matrix_with_uniform_random_weights
) # Try this on your machine - It'll evaluate to TRUE
```
...
* `hamming_distance` (Hamming distance)
    * Distance between patients is (1 * variable weight) summed over all variables
