...
Now, during settings_matrix generation, we can provide our dist_fns_list to ensure our new distance metrics will be used on some of our SNF runs.
...
It's important to note that the settings_matrix itself **does not store the distance metrics**, just the pointers to which position metric in the dist_fns_list should be used for that SNF run.
