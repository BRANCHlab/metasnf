...
All that aside, we show here a simple approach that involves assigning the clusters by a call to `batch_snf`, assembling a data list that has the training and testing set subjects, and feeding the results into a simple label propagating function, `lp_sol_df`.
...
```{r}
propagated_labels_all <- lp_sol_df(ext_sol_df, full_dl)
