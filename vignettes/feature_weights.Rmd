...
There's one column per feature (no need to worry about column orders) and the number of rows should match the number of rows in the settings_df.
...
Depending on which scheme is specified in the settings_df row, the feature columns that are involved at each distance matrix calculation can differ substantially.
