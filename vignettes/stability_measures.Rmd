...
<center>
![](https://raw.githubusercontent.com/BRANCHlab/metasnf/main/vignettes/ss_ari_hm.png){width=700px}
</center>
...
```{r eval = FALSE}
# Distribution of co-clustering among originally co-clustered pairs across
# subsamples
cocluster_density(cocluster_dfs[[1]])
```

<center>
![](https://raw.githubusercontent.com/BRANCHlab/metasnf/main/vignettes/cocluster_density.png){width=700px}
</center>
...
<center>
![](https://raw.githubusercontent.com/BRANCHlab/metasnf/main/vignettes/cc_hm.png){width=700px}
</center>
