...
output:
    rmarkdown::html_vignette:
        toc: true
description: >
  Visualize how cluster solutions separate over input/out-of-model variables.
vignette: >
...
esm_manhattan <- esm_manhattan_plot(
    ...
    jitter_width = 0.1,
    jitter_height = 0.1,
    plot_title = "Variable-Solution Associations",
    text_size = 14,
...
mc_manhattan <- mc_manhattan_plot(
    ...
    point_size = 3,
    text_size = 12,
    plot_title = "Variable-Meta Cluster Associations",
    threshold = 0.05,
    neg_log_pval_thresh = 5
)
