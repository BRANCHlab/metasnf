...
Alluvial plots can be generated to visualize how changing the number of clusters influences the distribution of observations according to one (or a few) variables of interest.
...
extra_data <- dplyr::inner_join(
    ...
    dplyr::mutate(subjectkey = paste0("subject_", unique_id))
