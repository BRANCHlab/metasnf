...
- `alpha` - Referred to as $\eta$ in the original SNF manuscript and alpha in the SNFtool code, this is a hyperparameter for affinity matrix generation
...
```{r}
output_matrix <- execute_design_matrix_soft(data_list, design_matrix)
