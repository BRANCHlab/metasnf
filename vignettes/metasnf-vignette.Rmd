...
The `batch_snf` function integrates the data in the `data_list` using each of the sets of settings contained in the `design_matrix`.
...
```{r}
output_matrix <- batch_snf(data_list, design_matrix)
...
train_output_matrix <- batch_snf(train_data_list, design_matrix)
