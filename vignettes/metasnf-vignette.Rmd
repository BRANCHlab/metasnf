...
By default, `generate_design_matrix` will build an empty dataframe containing the columns outlined in the [design matrix][Generating the `design_matrix`] section.
