...
Generate a wide range of similarity matrices and apply meta clustering to find a few representative.
One way to do this would be based on how the spectral-clustering derived solutions end up clustering together (see [example](https://branchlab.github.io/metasnf/articles/a_less_simple_example.html#examining-meta-clusters)).
Then pull take the corresponding affinity matrices and go through the dbscan clustering process manually.
