...
- **Prashanth S Velayudhan**. Author, maintainer.

- **Xiaoqiao Xu**. Author.

- **Prajkta Kallurkar**. Author.

- **Ana Patricia Balbon**. Author.

- **Maria T Secara**. Author.

- **Adam Taback**. Author.

- **Denise Sabac**. Author.

- **Nicholas Chan**. Author.
...
- **Stephanie H Ameis**. Author.

- **Brian Cox**. Author.

- **Colin Hawco**. Author.

- **Lauren Erdman**. Author.

- **Anne L Wheeler**. Author, thesis advisor.

## Citation

Source:
[`DESCRIPTION`](https://github.com/BRANCHlab/metasnf/blob/main/DESCRIPTION)
