...
-   More customization of design matrix - specifically, allowing
...
-   ~~Allow multi-feature dataframes to be used when generating an
    outcome list~~
-   ~~Make a vignette/minimal example of walking through the main steps
    of the pipeline~~
